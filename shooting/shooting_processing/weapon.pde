...
public class Laser extends Weapon
{
    ...
    {
        super(parent, x, y, 10.0, 5.0, color(255, 0, 0), 10, "arms01/laser1.mp3");
        effect.amp(0.2);
        this.vx = 0;
        this.vy = -5;
    }
...
public class Ougi extends Weapon
{
    ...
    {
        super(parent, x, y, 10.0, 5.0, color(255, 255, 50), 59, "arms01/laser5.mp3");
        effect.amp(0.2);
        this.vx = 0;
        this.vy = -5;
    }
...
public class Ougi2 extends Weapon
{
    ...
    {
        super(parent, x, y, 15.0, 15.0, color(255, 0, 100), 80, "arms01/launcher1.mp3");
        this.soundOn = true;
        this.vx = 0;
        this.vy = -5;
    }
...
public class Housya extends Weapon
{
    ...
    {
        super(parent, x, y, 10.0, 8.0, color(0, 255, 0), 30, "arms01/laser3.mp3");
        effect.amp(0.2);
        this.vx = 0;
        this.vy = -7;
    }
...
public class RotateLeft extends Weapon
{
    ...
    {
        super(parent, x, y, 15.0, 10.0, color(0, 255, 255), 15, "arms01/laser5.mp3");
        effect.amp(0.2);
        this.vx = 0;
        this.vy = -5;
